...
//     return (
//         // <div className="rounded-2xl border-stroke bg-white px-1 pt-6 pb-2.5 shadow-default">
...
//     //                     Masukan email dan password untuk Sign In!
//     //                 </p>
//     //             </div>
//     //             <div>
//     //                 <form>
...
const SignIn = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("token", userData.token);
      localStorage.setItem("role", userData.user.role);
      // localStorage.setItem("userId", data.user._id); // Simpan userId
        ...
        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                                    <input
                                    className="h-11 w-full rounded-lg border  border-gray-300 appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                    type = {showPassword ? "text" : "password"}
                                    placeholder="Enter your password"
                                    />
                                    <span
                                    ...
                                    >
                                        {showPassword ? (
                                            <EyeIcon className=" dark:fill-gray-300 size-5" opacity="0.5"/>
                                        ): (
                                            <EyeClosedIcon className=" dark:fill-gray-300 size-5" opacity="0.5" />
                                        )}
                                    </span>
                                </div>
            </div>
